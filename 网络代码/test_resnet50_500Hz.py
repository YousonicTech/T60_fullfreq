...
def parse_args():
    ...
    parser.add_argument('--epoch_for_save', type=int, default=17)  # 记得改epoch数
    parser.add_argument('--load_pretrain', type=bool, default=True)
    # 125Hz:(0, 7); 250Hz:(1, 10); 500Hz:(2, 13); 1kHz:(3, 16); 2kHz:(4, 19)
    parser.add_argument('--which_freq', type=int, default=4)   # 记得改成对应的图编号
    ...
    parser.add_argument('--outputresult_dir', type=str, default="./0915_test/epoch17") # 记得改输出路径，不用带/应该
...
if __name__ == "__main__":
    ...
    if DEBUG == False:
        ...
        val_batch_size = 3
        failed_file = "/Users/bajianxiang/Desktop/"
    else:
